...
#define NOT     ScriptArgumentType::NotUsed        //  0 | 사용하지 않음
#define ASC     ScriptArgumentType::AsciiChar      //  1 | 1바이트 아스키 값
#define NUM     ScriptArgumentType::Number         //  2 | 고정 또는 가변 숫자
#define STR     ScriptArgumentType::String         //  3 | 문자열 (char 길이)
#define STR2    ScriptArgumentType::String2        //  4 | 문자열 (short 길이)
#define REG     ScriptArgumentType::Register       //  5 | 1바이트 레지스터
#define CMP     ScriptArgumentType::Compare        //  6 | 비교 연산
#define ADD     ScriptArgumentType::AddValue       //  7 | 플래그 값 더하기
#define CNT     ScriptArgumentType::Count          //  8 | 고정 카운트
#define VCNT    ScriptArgumentType::VariableCount  //  9 | 가변 카운트
#define CHR     ScriptArgumentType::CharValue      // 16 | 1바이트 값
#define SHRT    ScriptArgumentType::ShortValue     // 17 | 2바이트 값
#define LONG    ScriptArgumentType::LongValue      // 18 | 4바이트 값
